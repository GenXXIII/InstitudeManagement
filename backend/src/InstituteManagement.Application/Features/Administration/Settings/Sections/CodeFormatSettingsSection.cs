...
public static partial class SettingsCatalog
{
    private static readonly SettingsSectionDefinition CodeFormatsSection = new(
        ...
        [
            ...
            ..ResourceCodeFormat("student", "STU", "ENR"),
            ..ResourceCodeFormat("teacher", "TEA", "ENR"),
            ..ResourceCodeFormat("department", "DEP", "ENR"),
            ..ResourceCodeFormat("course", "COU", "ENR"),
            ..ResourceCodeFormat("classroom", "CLA", "ENR"),
            ..ResourceCodeFormat("timetable", "TIM", "ENR"),
            ..ResourceCodeFormat("attendance", "ATT", "ENR"),
