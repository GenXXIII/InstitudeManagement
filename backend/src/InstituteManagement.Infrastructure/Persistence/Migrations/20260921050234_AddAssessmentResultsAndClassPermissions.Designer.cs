...
namespace InstituteManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921050234_AddAssessmentResultsAndClassPermissions")]
    partial class AddAssessmentResultsAndClassPermissions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InstituteManagement.Domain.Entities.ClassPermissionRequest", b =>
                {
                    ...
                    b.HasIndex("ScheduleEntryId", "StudentId", "SessionDate")
                        .IsUnique();

                    b.HasIndex("TeacherId", "SessionDate", "Status");
