...
public sealed class ResultQueryServiceTests
{
    ...
    public async Task Results_use_course_count_and_attendance_overrides()
    {
        ...
        var retake = new Student { StudentNumber = "S001", FullName = "Retake Student", DepartmentId = department.Id, YearLevel = 1 };
        var failed = new Student { StudentNumber = "S002", FullName = "Failed Student", DepartmentId = department.Id, YearLevel = 2 };
        var java = new Course { Code = "JAVA", Name = "Java", DepartmentId = department.Id };
        var csharp = new Course { Code = "CS", Name = "C#", DepartmentId = department.Id };
        ...
        var results = await new ResultQueryService(db).GetAsync(null, null, null, null, CancellationToken.None);
