...
{
    [Fact]
    public async Task Publish_all_archives_every_ready_result_with_its_own_code()
    {
        ...
        Assert.Empty(await service.GetAsync(null, null, null, null, false, CancellationToken.None));
