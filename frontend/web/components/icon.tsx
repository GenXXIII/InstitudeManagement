type IconName = "dashboard" | "bolt" | "users" | "teacher" | "room" | "book" | "calendar" | "check" | "building" | "finance" | "grade" | "chart" | "archive" | "settings" | "bell" | "search" | "menu" | "plus" | "arrow" | "pulse" | "close" | "trash" | "edit" | "folder";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  finance: <><rect x="3" y="6" width="18" height="14" rx="2"/><path d="M16 12h5M7 6V4h10v2M7 15h4"/><circle cx="16" cy="13" r="1"/></>,
  ...
  menu: <path d="M4 6h16M4 12h16M4 18h16"/>, plus: <path d="M12 5v14M5 12h14"/>, arrow: <path d="m9 18 6-6-6-6"/>, pulse: <path d="M3 12h4l2-6 4 12 2-6h6"/>, close: <path d="M18 6 6 18M6 6l12 12"/>, trash: <><path d="M3 6h18M8 6V4h8v2M19 6l-1 15H6L5 6M10 11v6M14 11v6"/></>, edit: <><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L8 18l-4 1 1-4z"/></>, folder: <path d="M3 6a2 2 0 0 1 2-2h5l2 2h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>,
};
