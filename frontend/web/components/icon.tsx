type IconName = "dashboard" | "bolt" | "users" | "teacher" | "room" | "book" | "calendar" | "check" | "building" | "grade" | "chart" | "archive" | "settings" | "bell" | "search" | "menu" | "plus" | "arrow" | "pulse" | "close" | "trash";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  menu: <path d="M4 6h16M4 12h16M4 18h16"/>, plus: <path d="M12 5v14M5 12h14"/>, arrow: <path d="m9 18 6-6-6-6"/>, pulse: <path d="M3 12h4l2-6 4 12 2-6h6"/>, close: <path d="M18 6 6 18M6 6l12 12"/>, trash: <><path d="M3 6h18M8 6V4h8v2M19 6l-1 15H6L5 6M10 11v6M14 11v6"/></>,
};
