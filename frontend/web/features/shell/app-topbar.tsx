    ...
    <div className="top-actions">
      ...
      <div className="topbar-popover-anchor">
        ...
        {profileOpen && <aside className="topbar-popover profile-popover">
          ...
          <button onClick={() => { setProfileOpen(false); navigateWorkspace("/settings/institute"); }}>Institute profile</button>
          <button onClick={() => { setProfileOpen(false); navigateWorkspace("/settings/system"); }}>System preferences</button>
          <button onClick={() => { setProfileOpen(false); navigateWorkspace("/records/students"); }}>Audit history</button>
        </aside>}
      </div>
    </div>
  </header>;
