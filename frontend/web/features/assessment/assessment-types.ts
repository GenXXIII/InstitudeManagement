export type GradeAssessmentValues = {
  ...
  reviewStatus: "SubmissionRequested" | "SubmissionAuthorized" | "Submitted" | "Pending" | "Approved" | "Rejected" | "ResubmitRequested" | "ResubmitAuthorized"; reviewNote: string; submissionVersion: string; submittedAtUtc: string; reviewedAtUtc: string; createAt: string;
};
