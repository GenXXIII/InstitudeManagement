...
export default function OperationsWorkspace() {
  ...
  return <div className={`viewport-data-page operations-workspace ${visual ? "operations-visual-workspace" : ""}`}>
    <PageHeading eyebrow={dashboard ? "Institute operations" : "Live operation"} title={dashboard ? "Operation Overview" : data.title} description={`${data.description}${year ? ` Showing Year ${year}.` : ""}`}/>
