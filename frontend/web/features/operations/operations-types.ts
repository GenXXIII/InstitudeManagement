...
export type WeeklyTimetableSlot = { id: string; timetableCode: string; day: string; session: string; startsAt: string; endsAt: string; course: string; teacher: string; yearLevel: number; room: string; roomType: string; status: string };
