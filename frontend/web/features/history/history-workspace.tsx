...
function RecordRegister() {
  ...
  return <div className="viewport-data-page history-viewport-page">
    ...
    <section className="record-lock-notice"><div><Icon name="archive" size={18}/></div><p><strong>Permanent read-only history</strong><span>Enrollment, Management, and Operations control current data. History preserves every captured snapshot and change.</span></p></section>
