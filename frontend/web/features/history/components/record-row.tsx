...
function historyCodeLabel(type: string) {
  if (type === "Finance") return "FinancialAccountCode";
  return type === "Class session" ? "ClassSessionRecordCode" : `${type.replaceAll(" ", "")}Code`;
}

function recordIcon(type: string): Parameters<typeof Icon>[0]["name"] { return type === "Student" ? "users" : type === "Teacher" ? "teacher" : type === "Classroom" ? "room" : type === "Course" ? "book" : type === "Timetable" ? "calendar" : type === "Attendance" ? "check" : type === "Department" ? "building" : type === "Grade" ? "grade" : type === "Finance" ? "finance" : "archive"; }
