...
export const managementCopy: Record<ManagementModule, { title: string; description: string; singular: string }> = {
  ...
  students: { title: "Student profile management", description: "Maintain the student's reusable identity. Academic placement and the mobile Login Public ID are shown under Student Assign.", singular: "student" },
  teachers: { title: "Teacher profile management", description: "Maintain the teacher's reusable identity. Academic assignment and the mobile Login Public ID are shown under Teacher Assign.", singular: "teacher" },
