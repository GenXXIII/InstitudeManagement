...
export const managementCopy: Record<ManagementModule, { title: string; description: string; singular: string }> = {
  ...
  timetable: { title: "Timetable planner", description: "Schedule Year 1–4 cohorts across 13 concurrent classrooms and meeting rooms without double-booking.", singular: "class" },
